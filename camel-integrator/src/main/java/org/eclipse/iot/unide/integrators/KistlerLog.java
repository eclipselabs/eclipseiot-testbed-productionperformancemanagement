...
public class KistlerLog implements Processor {
	...
	public KistlerLog() {
		this("/html/body/span[2]/text()", "/html/body/p[2]/table[@bgcolor='lime']/tbody/tr/td/table/tbody/tr", "/html/body/p[2]/table[@bgcolor='aqua' and position() = 1]/tbody/tr[position() = last()]/td[2]/span/text()");
	}
	...
	public void process(Exchange exchange) throws JsonProcessingException, Exception {
		...
		switch(result) {
			case "0": process.setResult(Result.NOK); break;
			case "1": process.setResult(Result.OK); break;
			default: process.setResult(Result.UNKNOWN);
		}
